Frontend não dockerizado — rodar via npm mesmo

Pensei em botar tudo num único docker-compose (backend + banco + frontend), mas isso aumenta a complexidade do projeto sem necessidade agora. O motivo real não é "dá trabalho" — é que, nesta fase, o que importa é provar que o sistema funciona e manter o repositório limpo e fácil de entender, com uma história simples de acompanhar. Dockerizar o frontend agora significaria:
...
4. Frontend e backend em repositórios separados, não no mesmo
